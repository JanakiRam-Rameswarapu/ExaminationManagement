	...
	public static void question() throws Exception{
	           ...
	           ResultSet resultSet = statement.executeQuery(sql2);
	            ...
	            while (resultSet.next()) {
	                ...
	                String sql3 = "INSERT INTO user_answers (rollNo,question_id, user_answer) VALUES (?,?, ?)";
	                PreparedStatement preparedStatement = con.prepareStatement(sql3);

	                preparedStatement.setString(1, rs);
	            ...
	            while (resultSet.next()) {
	                ...
	                String sql5 = "SELECT rollNo,user_answer FROM user_answers WHERE question_id = ?";
